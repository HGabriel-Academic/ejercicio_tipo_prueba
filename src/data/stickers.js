const rawStickers = [
  ...
  { id: 43, code: 'BRA14', name: 'Vinícius Jr.', section: 'Brasil', group: 'Grupo C', type: 'jugador', rarity: 'base' },
  ...
  { id: 56, code: 'FRA7', name: 'Theo Hernandez', section: 'Francia', group: 'Grupo I', type: 'jugador', rarity: 'base' },
  ...
  { id: 117, code: 'GER8', name: 'İlkay Gündoğan', section: 'Alemania', group: 'Grupo E', type: 'jugador', rarity: 'base' },
...
export const stickers = rawStickers.map((sticker) => ({
  ...sticker,
  number: sticker.id,
  status: 'missing',
}));
